...
public class ModDamageTypeTags {
    ...
    public static final TagKey<DamageType> IS_COLD_DAMAGE = create("murabitoattributes:is_cold_damage");
    ...
    public static final TagKey<DamageType> IS_TRUE_DAMAGE = create("murabitoattributes:is_true_damage");
