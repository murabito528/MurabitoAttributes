...
public class ChaosOrbItem extends CurrencyItem{
    ...
    public boolean applyEffect(ItemStack target, ItemStack currency, Player player) {
        CurrencyActions.chaos(target, RandomSource.create());
        return true;
    }

    @Override
    public void appendHoverText(ItemStack stack, @Nullable Level worldIn, List<Component> tooltip, TooltipFlag flagIn) {
        tooltip.add(Component.literal("レア以下のアイテムをランダムなモッドを持つレアアイテムにリフォージする").withStyle(ChatFormatting.DARK_GRAY));
